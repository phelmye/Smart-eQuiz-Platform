...
// Local currency formatter (since @smart-equiz/utils may not be available in this workspace)
...
export const TenantLandingPage: React.FC<TenantLandingPageProps> = ({ tenant, onAuthSuccess }) => {
  ...
  useEffect(() => {
    // Load custom landing page content from localStorage
    try {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50">
      ...
      {/* Featured Tournament Section - Only show if tournament exists */}
      {featuredTournament && (
                    ...
                    <div className="text-center md:text-left">
                      ...
                      <div className="text-2xl font-bold text-gray-900">
                        {featuredTournament.entryFee > 0 
                          ? formatCurrency(featuredTournament.entryFee, 'USD', 'en-US')
                          : 'FREE'}
                      </div>
                      {tournamentType === 'upcoming' && featuredTournament.entryFee > 0 && (
                        <div className="text-sm text-gray-600 mt-1">Per participant</div>
                      )}
                    </div>
                  </div>
                    ...
                    {tournamentType === 'upcoming' ? (
                      <>
                        ...
                        <Button 
                          ...
                          className="flex-1 text-lg py-6"
                          onClick={() => {
                            console.log('View tournament details');
                          }}
                        >
                          View Details
                          <ArrowRight className="ml-2 h-5 w-5" />
                      ...
                      <>
                        <Button 
                          ...
                          className="flex-1 text-lg py-6"
                          onClick={() => {
                            console.log('View tournament results');
                          }}
                        >
                          <Trophy className="mr-2 h-5 w-5" />
                          View Results
          ...
          <div className="max-w-4xl mx-auto">
            <div className="grid md:grid-cols-4 gap-8">
              ...
              <div className="text-center">
                ...
                <h4 className="font-semibold mb-2">Choose Your Parish</h4>
                <p className="text-sm text-gray-600">Join your church community</p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-sm text-gray-600">Build your Bible knowledge daily</p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-sm text-gray-600">Join tournaments and earn prizes</p>
              </div>
            </div>
          </div>
        </div>
