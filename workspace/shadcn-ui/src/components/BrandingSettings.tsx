...
export const BrandingSettings: React.FC<BrandingSettingsProps> = ({ onBack }) => {
  ...
  const isLocked = user ? !hasFeatureAccess(user, 'branding') : true;
  const featureInfo = user ? getFeatureDisplayInfo(user, 'branding') : null;
  ...
  // Feature preview overlay for locked features
