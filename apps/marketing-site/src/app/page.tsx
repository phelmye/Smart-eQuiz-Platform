  ...
  return (
    <div className="min-h-screen">
        ...
        <div className="container mx-auto px-4 py-20 md:py-32">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl md:text-2xl mb-8 text-blue-100">
              ...
              and competitive championships for churches worldwide.
            </p>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Powerful features designed specifically for Bible quiz programs
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            ...
            <div className="p-6 rounded-lg border border-gray-200 hover:shadow-lg transition-shadow">
              ...
              <p className="text-gray-600">
                Create and manage tournaments with brackets, schedules, and real-time scoring
              </p>
            </div>
            ...
            <div className="p-6 rounded-lg border border-gray-200 hover:shadow-lg transition-shadow">
              ...
              <p className="text-gray-600">
                Comprehensive question library with AI-powered generation and custom categories
              </p>
            </div>
            ...
            <div className="p-6 rounded-lg border border-gray-200 hover:shadow-lg transition-shadow">
              ...
              <p className="text-gray-600">
                Track performance, participation, and progress with detailed insights
              </p>
            </div>
            ...
            <div className="p-6 rounded-lg border border-gray-200 hover:shadow-lg transition-shadow">
              ...
              <p className="text-gray-600">
                Organize participants, coaches, and administrators with role-based access
              </p>
            </div>
            ...
            <div className="p-6 rounded-lg border border-gray-200 hover:shadow-lg transition-shadow">
              ...
              <h3 className="text-xl font-semibold mb-2">Live Match Mode</h3>
              <p className="text-gray-600">
                Real-time scoring, buzzer integration, and live leaderboards for exciting matches
              </p>
            </div>
            ...
            <div className="p-6 rounded-lg border border-gray-200 hover:shadow-lg transition-shadow">
              ...
              <h3 className="text-xl font-semibold mb-2">Global Currency Support</h3>
              <p className="text-gray-600">
                Support 12 currencies worldwide with automatic conversion and local pricing
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-4 gap-8 text-center">
            ...
            <div>
              ...
              <div className="text-gray-600">Churches Served</div>
            </div>
            <div>
              <div className="text-4xl font-bold text-blue-600 mb-2">50K+</div>
              <div className="text-gray-600">Quizzes Hosted</div>
            </div>
            <div>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold mb-4">Loved by Churches Worldwide</h2>
            <p className="text-xl text-gray-600">
              See what our customers are saying about Smart eQuiz
            </p>
          </div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            ...
            {/* Professional Plan */}
            <div className="bg-blue-600 text-white p-8 rounded-lg shadow-xl transform scale-105">
              <div className="inline-block bg-yellow-400 text-blue-900 text-xs font-bold px-3 py-1 rounded-full mb-4">
                MOST POPULAR
              </div>
              ...
              <Link 
                ...
                className="block w-full py-3 text-center bg-white text-blue-600 rounded-lg font-semibold hover:bg-blue-50 transition-colors"
              >
                Get Started
              </Link>
            </div>
      ...
      <section className="py-20 bg-blue-600 text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-4xl font-bold mb-4">
            Ready to Transform Your Bible Quiz Program?
          </h2>
          <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
            Join hundreds of churches worldwide using Smart eQuiz to engage their communities
          </p>
          <Link 
            href="/signup"
